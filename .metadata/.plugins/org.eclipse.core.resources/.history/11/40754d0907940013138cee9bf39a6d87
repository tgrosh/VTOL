...
{	
        ...
        public ObjectiveParser(LanderScene scene, int chapterID, int levelID, IObjectiveListener objectiveListener)
        {
        	this.scene = scene;
        	...
        	else if(localName.equals("objective"))
            {
        		if (levelFound && chapterFound){
	                ...
	                if (type.equals("ZoneObjective")){
		                ...
		                objectives.add(new ZoneObjective(scene, id, objectiveZoneID, description, prerequisiteID, objectiveListener));
	                }
	                else if (type.equals("SafeReturnObjective")){
	                	objectives.add(new SafeReturnObjective(scene, id, description, prerequisiteID, objectiveListener));
	                }
        		}
            }
            else
